...
public class InterceptorConfig implements WebMvcConfigurer {
    ...
    private static final String[] EXCLUDE_PATH = {"/api/article/**", "/api/member/signup","/swagger-ui.html", "/api/member/naverlogin", "/api/member/kakaologin", "/api/member/list", "api/member/friendlist"};
